...
| --- | --- | --- |
| `web/dist/` | `<remote root>/` | https://benefits.aicountly.com |
| `server-php/` | `<remote root>/api/` | https://benefits.aicountly.com/api |
...
`https://benefits.aicountly.com/api/.env` unless Apache is told otherwise. `server-php`
