 ...
 * benefits.aicountly.com and benefits.gh.aicountly.com. This is the fallback for
 * hosts the pattern does not cover — localhost above all.
 */
export const PRODUCT_KEY = (import.meta.env.VITE_PRODUCT_KEY ?? 'benefits').trim() || 'benefits'
...
/**
 * `benefits.aicountly.com` and `benefits.gh.aicountly.com` both resolve to
 * `benefits`, which is what the portal expects in authentication_jump.
 */
