/**
 * Google Analytics 4 (gtag) for benefits.aicountly.com.
 *
 * Set at build time: VITE_GA4_SAAS_BENEFITS_MEASUREMENT_ID=G-…
 * Flow backend: GA4_PROPERTY_ID_SAAS_BENEFITS (numeric property ID).
 */
...
const GA4_ID: string =
  import.meta.env.VITE_GA4_SAAS_BENEFITS_MEASUREMENT_ID ||
