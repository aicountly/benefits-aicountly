...
export const APP_NAME = (import.meta.env.VITE_APP_NAME ?? 'Benefits').trim() || 'Benefits'
 ...
 * with the app on both benefits.aicountly.com and benefits.gh.aicountly.com. That
