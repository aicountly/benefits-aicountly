...
Benefits for Aicountly — a React single-page app built with Vite and TypeScript,
with a small PHP API alongside it. Both halves deploy to cPanel.

| Environment | App | API |
| --- | --- | --- |
| Production | https://benefits.aicountly.com | https://benefits.aicountly.com/api |
| Sandbox | https://benefits.gh.aicountly.com | https://benefits.gh.aicountly.com/api |
...
(`https://benefits.gh.aicountly.com/api`) so the token exchange has somewhere to
